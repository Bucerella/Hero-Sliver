...
class TicketDetailState extends State<TicketDetail> with SingleTickerProviderStateMixin<TicketDetail> {
      ...
      body: Column(
        children: <Widget>[
          ...
          OutlineButton(
            ...
            child: Text("Other HERO & SLIVER PAGE"),
            onPressed: (){
              var route = MaterialPageRoute(builder: (c) => SliverHero());
